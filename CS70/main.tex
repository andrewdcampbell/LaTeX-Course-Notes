...
def Euler(G,s): 
    ...
    return splice(T,Euler(G_1,s_1),...
        ...
        The $n$-dimensional hypercube is well-connected in the following sense: \textit{Theorum}: Let $S \subseteq V$ be such that $|S| \geq |V - S|$ (i.e., that $|S| \geq 2^{n-1}$), and let $E_S$ denote the set of edges connecting $S$ to $V - S$. Then, it holds that $|E_S| \geq |S|$.
